# -*- coding: utf-8 -*-
"""
Created on Fri Dec 21 20:40:29 2018
...
f = open('E:\Class\Data\drinks.csv', 'rU')
...
with open('E:\Class\Data\drinks.csv', 'rU') as f:
...
nums = range(5)
with open('E:/Class/Data/Nums.txt', 'w+') as f:
    for num in nums:
        f.write(str(num) + '\n')

# convert a list of lists into a CSV file
output = [['col1', 'col2', 'col3'], [4, 5, 6]]
with open("E:\Class\Data\example.csv", 'w+') as f:
    for row in output:
